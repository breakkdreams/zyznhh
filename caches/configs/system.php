...
'cookie_pre' => 'ZgwDe_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/zyznhh/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost/zyznhh/statics/js/', //CDN JS
'css_path' => 'http://localhost/zyznhh/statics/css/', //CDN CSS
'img_path' => 'http://localhost/zyznhh/statics/images/', //CDN img
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'b1rz0Ya2OwHALANyeghG', //密钥
'lang' => 'zh-cn',  //网站语言包
