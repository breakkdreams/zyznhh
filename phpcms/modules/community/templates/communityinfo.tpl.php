	...
	<div id="div_setting_2" class="contentList">
		...
		<table width="100%" class="table_form">
			<tbody>
				...
				<tr>
					<th width="125">用户头像</th>  
					<td>
						<img src="<?php echo $community['userhead'] ?>" style="width:30px;height:30px;">
					</td>
				</tr>
				<tr>
					<th width="125">用户名</th>  
					<td>
						<?php echo $community['username'] ?>
					</td>
				</tr>
				<tr>
					<th width="125">动态内容</th>  
					<td>
						<?php echo $community['content'] ?>
					</td>
				</tr>
				<tr>
					<th width="125">动态图片</th>  
					<td>
					<img src="<?php echo $community['img'] ?>" style="width:100px;height:100px;">
					</td>
				</tr>
				<tr>
