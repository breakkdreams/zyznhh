        ...
        <table width="100%" class="table_form">
            <tbody>
                ...
                <tr>
                    ...
                    <td><span><?php echo $info['config_name'] ?></span></td>
                </tr>
        
                <tr>
                    <th width="125">配置API地址</th>  
                    <td><input type="text" style="width: 100%" name="url" id="contact" class="input-text" value="<?php echo $info['url'] ?>"><span id="balance"></span></input></td>
                </tr>
                <tr>
                    <th width="125">更改所需模块</th>  
                    <td>
                        <select name="model_name">
                        <?php foreach($into as $r)
                        {
                        ?>              
                        <option value="<?php echo $r['module']." ".$r['name'] ?>"
                                <?php if($r['module']." ".$r['name']==$info['model_name']){echo "selected";}?>
                        ><?php echo $r['module']." ".$r['name'] ?></option>
                        <?php 
                        }
                        ?>
                    </select>
