...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>zycms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> <br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<div class="content">
	<?php echo L('main_copyright')?>台州市卓远网络科技有限公司设计制作<br />
	<?php echo L('main_product_dev')?><?php echo $programmer;?><br />
	<?php echo L('main_product_ui')?><?php echo $designer;?><br />
	<?php echo L('main_product_site')?><a href="http://www.300c.cn/" target="_blank">http://www.300c.cn/</a> <br />
	<?php echo L('main_product_sales')?>24356264
	</div>
</div>
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>zycms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> <br />
	<?php echo L('main_license_type')?>完全授权<br />
	<?php echo L('main_serial_number')?>ZYCMS-DFSDBRRDG-638-SBEDF-D2339<br />
	</div>
</div>
    <div class="bk10"></div>
</div>
