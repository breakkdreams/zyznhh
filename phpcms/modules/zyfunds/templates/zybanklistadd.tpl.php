			...
			<div id="div_setting_2" class="contentList">
				...
				<table width="100%" class="table_form" id="mytable">
					<tbody>
						<tr>
							<th width="125">银行</th>
							<td><input style="width: 50%;" type="text" name="bank" id="bank" class="input-text" required=""></td>
						</tr>
						<tr>
							<th width="125">描述</th>
							<td><input style="width: 50%;" type="text" name="desc" id="desc" class="input-text" required=""></td>
						</tr>
						<tr>
							<th>银行LOGO</th>
							<td>
