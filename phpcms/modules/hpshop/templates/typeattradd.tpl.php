		...
		<table width="100%" class="table_form">
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="aname" id="aname" class="input-text" required=""><span id="balance"></span></input></td>
				</tr>

				<tr>
					<th>是否显示</th>  
					<td>
						<input type="radio" name="show" id="pts" value="1" checked="checked">
						<label for="pts">显示</label>

				        <input type="radio" name="show" id="fxss" value="0">
				...
				<tr>
					<th>属性类型</th>  
					<td>
						<input type="radio" name="status" id="pt" value="0" checked="checked">
						<label for="pt">输入框</label>

				        <input type="radio" name="status" id="fxs" value="1">
						<label for="fxs">多属性</label>
					</td>
				</tr> 

				<tr id="mnam2" style="display: none;">
					<th width="125">属性值</th>  
					<td><textarea style=" width: 500px; resize: vertical; height: 100px;" name="value" placeholder="多属性值用,隔开"></textarea></td>
				</tr>
