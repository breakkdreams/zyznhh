...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#pname").formValidator({onshow:"请填写推荐位名称",onfocus:"请填写推荐位名称"}).inputValidator({min:1,max:999,onerror:"推荐位名称不能为空"}).ajaxValidator({

	    type : "get",
		url : "",
		data :"m=hpshop&c=goods&a=checkposition_ajax&id=<?php echo $info['id'];?>",
		datatype : "html",
		async:'false',
	...
	<div id="div_setting_2" class="contentList">
		...
		<table width="100%" class="table_form">
			<tbody>
				...
				<tr>
					<th width="125">推荐位名称</th>  
					<td><input type="text" name="pname" id="pname" class="input-text" value="<?php echo $info['posname'];?>" required=""><span id="balance"></span></input></td>
				</tr>
