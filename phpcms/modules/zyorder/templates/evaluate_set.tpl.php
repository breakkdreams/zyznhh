...
<table width="100%" cellspacing="0">
    <thead>
        <tr>
            ...
            <th align="center"><strong>评价描述</strong></th>
            <th align="center"><strong>评分代码</strong></th>
...
if(is_array($info)){
    ...
    <tr>
        ...
        <td align="center"><?php echo $info1['id']?></td>
         ...
         <td align="center"><?php if($info1['activate']==0){echo '未激活';}else{echo '已激活';}?></td>
		 <td align="center">
		 <?php if($info1['activate']==0){
			 echo '<a href="javascript:void(0);" onclick="view2(\'93\')"><font color="red">激活</font></a>';
		 }else{
		     echo '<a href="javascript:void(0);" onclick="view2(\'93\')"><font color="blue">取消</font></a>';
		 }?></td>
    </tr>
    <?php
    }
