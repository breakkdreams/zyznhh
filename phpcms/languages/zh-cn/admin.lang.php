...
//index
$LANG['admin_site_title'] = 'ZYCMS - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = 'ZYCMS内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将ZYCMS目录设置为755（linux）或只读（windows）';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.300c.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.300c.cn/，请以‘/’结束';
