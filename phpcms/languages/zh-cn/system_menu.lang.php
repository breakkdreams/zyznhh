...
$LANG['advertisement_list'] = '广告列表';
$LANG['add_advertisement'] = '添加广告';
$LANG['edit_advertisement'] = '编辑广告';
$LANG['del_advertisement'] = '删除广告';
$LANG['advertisement_stat'] = '广告统计';
$LANG['advertisement_setting'] = '模块配置';
$LANG['create_advertisement_js'] = '重新生成js';
$LANG['advertisement_template'] = '广告模板设置';
$LANG['zymarketing'] = '营销模块';
$LANG['ad_module'] = '广告系统';
$LANG['ad_manage'] = '广告管理';
$LANG['hpshop'] = '商品管理';
$LANG['goodsmanage'] = '商品管理';
$LANG['goodslist'] = '商品列表';
$LANG['goodsbrand'] = '商品品牌';
$LANG['goodsposition'] = '推荐位管理';
$LANG['goodsverify'] = '商品审核';
$LANG['sortmanage'] = '分类管理';
$LANG['catsort'] = '商品分类';
$LANG['goodstype'] = '商品类型';
$LANG['zyconfig'] = '配置管理';
$LANG['zyconfigss'] = '商品配置';
$LANG['zyaddrsys'] = '地址管理';
$LANG['zyaddrmanage'] = '地址管理';
$LANG['zyaddr'] = '地址管理列表';
$LANG['zyaddrmanage_add'] = '添加地址';
$LANG['zyaddrmanage_edit'] = '编辑地址';
$LANG['zyaddrmanage_del'] = '删除地址';
$LANG['zyconfigmenu'] = '配置模块';
$LANG['zyaddr_configs'] = '地址配置';
$LANG['zyfunds'] = '资金管理';
$LANG['zyrwc'] = '资金项目管理';
$LANG['zhmanage'] = '账号管理';
$LANG['zyrechargelist'] = '充值列表';
$LANG['zywithdrawcash'] = '提现列表';
$LANG['zybanklist'] = '银行信息';
$LANG['zyconfigs'] = '提现充值配置';
$LANG['ordermodule'] = '订单模板';
$LANG['logistics'] = '物流管理';
$LANG['logistics_company'] = '物流配置';
$LANG['order'] = '订单管理';
$LANG['order_list'] = '订单管理列表';
$LANG['zymessagesysmenu'] = '通讯模块';
$LANG['messagesys'] = '消息模块';
$LANG['syssms_platform'] = '系统消息管理';
$LANG['message_manage'] = '消息管理';
$LANG['message_manage_adddf'] = '单发消息';
$LANG['message_manage_addqf'] = '群发消息';
$LANG['sms_platform'] = '短信模块';
$LANG['sms_confing'] = '平台设置';
$LANG['sms_record'] = '消费记录';
$LANG['sms_model'] = '短信模板';
